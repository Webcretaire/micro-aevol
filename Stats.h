...
protected:
    ...
    int nb_bases_in_0_CDS_ = 0;
    int nb_bases_in_0_functional_CDS_ = 0;
    int nb_bases_in_0_non_functional_CDS_ = 0;
    int nb_bases_in_0_RNA_ = 0;
    int nb_bases_in_0_coding_RNA_ = 0;
    int nb_bases_in_0_non_coding_RNA_ = 0;

    int nb_bases_non_essential_ = 0;
    int nb_bases_non_essential_including_nf_genes_ = 0;
